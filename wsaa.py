...
CERT = "certificado_testing_renzo_dev_vb_ubuntu16.crt"        # El certificado X.509 obtenido de Seg. Inf.
PRIVATEKEY = "pk_renzo_dev.key"  # La clave privada del certificado CERT
